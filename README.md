...
この構成を採用した理由は、前身の静的サイト版で作った変換ロジックを活かしつつ、ブラウザ上で素早く操作できる体験を保つためです。レシピ変換の中心処理はフロントエンドで完結し、プリセット保存やレシピ共有などユーザーごとのデータを扱う部分をDjango側で受け持っています。
...
![マイページ](articles/static/images/mypreset-description/mypage.png)

![プリセット作成画面](articles/static/images/mypreset-description/preset-create.png)

### レシピ共有機能
3つ目の機能として「レシピ共有機能」があります。変換したレシピを他の人と共有できる機能です。
