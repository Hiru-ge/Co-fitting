...
export const CATEGORY_MAP: Record<string, CategoryInfo> = {
  ...
  meal_takeaway: { label: "テイクアウト", icon: "takeout_dining", gradient: "from-orange-500 to-red-700" },
  ...
  ramen_restaurant: { label: "ラーメン", icon: "ramen_dining", gradient: "from-red-600 to-orange-800" },
  // アウトドア・自然
  park: { label: "公園", icon: "park", gradient: "from-green-500 to-emerald-700" },
  campground: { label: "キャンプ", icon: "forest", gradient: "from-green-700 to-emerald-900" },
  beach: { label: "ビーチ", icon: "beach_access", gradient: "from-cyan-400 to-blue-600" },
  lake: { label: "湖・川", icon: "water", gradient: "from-blue-500 to-cyan-700" },
  ...
  bowling_alley: { label: "ボーリング", icon: "sports_cricket", gradient: "from-blue-600 to-indigo-800" },
  karaoke: { label: "カラオケ", icon: "mic", gradient: "from-pink-500 to-rose-700" },
  amusement_center: { label: "ゲームセンター", icon: "videogame_asset", gradient: "from-violet-500 to-purple-700" },
  video_arcade: { label: "ゲームセンター", icon: "videogame_asset", gradient: "from-violet-500 to-purple-700" },
  ...
  fitness_center: { label: "ジム", icon: "fitness_center", gradient: "from-orange-500 to-red-700" },
  ...
  public_bath: { label: "銭湯", icon: "hot_tub", gradient: "from-cyan-600 to-teal-800" },
  sauna: { label: "サウナ", icon: "hot_tub", gradient: "from-orange-700 to-red-900" },
  // ショッピング
  ...
  department_store: { label: "デパート", icon: "storefront", gradient: "from-violet-400 to-purple-600" },
  home_goods_store: { label: "雑貨", icon: "home", gradient: "from-amber-500 to-orange-700" },
  // 観光・文化
  ...
  hindu_temple: { label: "寺院", icon: "temple_buddhist", gradient: "from-red-700 to-rose-900" },
  mosque: { label: "モスク", icon: "temple_buddhist", gradient: "from-green-600 to-teal-800" },
  synagogue: { label: "礼拝堂", icon: "temple_buddhist", gradient: "from-indigo-600 to-blue-800" },
};
...
export function getBestCategoryKey(types: string[]): string {
  ...
  if (import.meta.env.DEV && types.length > 0) {
    console.warn(`[category-map] No CATEGORY_MAP entry found for types: [${types.join(", ")}]. Falling back to "${types[0]}".`);
  }
